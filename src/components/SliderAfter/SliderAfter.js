        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <div class="caption-bg">
              ...
              <p>
                People use technology in different ways, for a variety of
                reasons
              </p>
            </div>
          </Carousel.Caption>
          ...
          <Carousel.Caption>
            <div class="caption-bg">
              ...
              <p>
                ...
                taking a new perspective helps drive innovation
              </p>
            </div>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <div class="caption-bg">
              ...
              <p>
                The social media says, 'this person can't do this task because
                of the way society built their surrounding environments'
              </p>
            </div>
          </Carousel.Caption>
        </Carousel.Item>
